...
export default function PlaceAdvertisementScreen(props){
...
}/>),headerRight: ()=>(<View style={{marginRight: 10}}>{image && <Button title={"Next"} onPress={()=>props.navigation.navigate("Advertisement Payment",{image: image,advertiser: props.route.params.advertiser,text:text})} />}</View>),gestureEnabled: false
  })
  })
  ...
  return (
    <ScrollView style={{flex: 1,backgroundColor: "white"}}>
          <TextInput
            placeholder="Type Advertisement Details Here..."
